    ...
    <main className="flex flex-col h-full px-4 md:px-0 bg-indigo-300 items-start p-12">
      <div className="flex flex-col container items-center bg-gray-800 mx-auto px-4 md:px-20 rounded-2xl py-14 space-y-3">
        <div className="flex flex-col w-full md:w-1/2">
          ...
          <span className="text-indigo-200 text-center py-4">
            They are unquacking-believable. Also, this idea is based on the{" "}
            <a
              href="https://www.debonogroup.com/services/core-programs/six-thinking-hats/"
              target="blank"
              className="underline"
            >
              Six Thinking Hats
            ...
            <div className="flex w-full flex-col h-72 md:h-72 md:w-1/2 items-center">
              <div className="flex w-full h-full bg-white px-6 py-6 md:px-8 md:py-8 rounded-t-md">
                <span className="text-slate-700 text-base">
                  ...
                  pitfalls. Much like a detective duck, always on the lookout
                  and solving mysteries at the pond. One could say this duck is
            ...
            <div className="flex w-full flex-col h-72 md:h-72 md:w-1/2 items-center">
              <div className="flex w-full h-full bg-white px-6 py-6 md:px-8 md:py-8 rounded-t-md">
                <span className="text-slate-700 text-base">
                  ...
                  big thing for the duck world, perhaps even launching other
                  ducks to the moon. This duck definitely has all its ducks in a
                  row!
                </span>
              </div>
              <div className="flex relative w-full flex-row items-end bg-indigo-600 rounded-b-md px-4 py-4">
            ...
            <div className="flex w-full flex-col h-72 md:h-72 md:w-1/2 items-center">
              <div className="flex w-full h-full bg-white px-6 py-6 md:px-8 md:py-8 rounded-t-md">
                <span className="text-slate-700 text-base">
                  ...
                  redefine pond fashion. An artistic soul, this duck isn&#39;t
                  afraid to swim against the current and create ripples of
                  change.
                </span>
              </div>
              <div className="flex relative w-full flex-row items-end bg-indigo-600 rounded-b-md px-4 py-4">
                ...
                <div className="flex flex-col md:flex-row w-full items-left md:items-center pl-4 md:pl-20">
                  ...
                  <span className="text-indigo-300 text-xs text-center pl-2">
                    Creative, Similar Ideas, Alternatives
                  </span>
                </div>
              </div>
            </div>
            <div className="flex w-full flex-col h-72 md:h-72 md:w-1/2 items-center">
              <div className="flex w-full h-full bg-white px-6 py-6 md:px-8 md:py-8 rounded-t-md">
                <span className="text-slate-700 text-base">
                  ...
                  trees on the shores of the pond. Every cloud in the sky has a
                  silver quacking to this one.
                </span>
              </div>
              <div className="flex relative w-full flex-row items-end bg-indigo-600 rounded-b-md px-4 py-4">
                <img src="/black-duck.png" className="w-12 md:w-16 absolute" />
                <div className="flex flex-col md:flex-row w-full items-left md:items-center pl-4 md:pl-20">
                  ...
                  <span className="text-indigo-300 text-xs text-center pl-2">
                    Benefits, Positivity, Useful outcomes
                  </span>
                </div>
              </div>
            </div>
            ...
            <div className="flex w-full flex-col h-72 md:h-72 md:w-1/2 items-center">
              <div className="flex w-full h-full bg-white px-6 py-6 md:px-8 md:py-8 rounded-t-md">
                <span className="text-slate-700 text-base">
                  ...
                  It&#39;s much like a distinguished duck who&#39;s waddled
                  through the philosophical ponds of logic and reason. If ducks
                  had their own Nobel Prize for logic and quack-osophy, this one
                  would&#39;ve won it hands-down.
                </span>
              </div>
              <div className="flex relative w-full flex-row items-end bg-indigo-600 rounded-b-md px-4 py-4">
                <img src="/black-duck.png" className="w-12 md:w-16 absolute" />
            ...
            <div className="flex w-full flex-col h-72 md:h-72 md:w-1/2 items-center">
              <div className="flex w-full h-full bg-white px-6 py-6 md:px-8 md:py-8 rounded-t-md">
                <span className="text-slate-700 text-base">
                  ...
                  pond with tunes that make other ducks flutter with emotions.
                  If you ever feel down, just remember to &#39;&#39;Don&#39;t
                  Worry, Be Quacky!&#39;&#39;
                </span>
              </div>
              <div className="flex relative w-full flex-row items-end bg-indigo-600 rounded-b-md px-4 py-4">
                ...
                <div className="flex flex-col md:flex-row w-full items-left md:items-center pl-4 md:pl-20">
                  ...
                  <span className="text-indigo-300 text-xs text-center pl-2">
                    Emotional, Intuitive, Empathetic
                  </span>
                </div>
              </div>
            </div>
